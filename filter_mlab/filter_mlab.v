...
// Generated on: 2017-04-12 19:25:11
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
//Module Architecture: filter_mlab
////////////////////////////////////////////////////////////////
  // Local Functions
  // Type Definitions
  // Constants
  ...
  assign  phase_8 = (cur_count == 4'b1000 && i_clk_enable == 1'b1)? 1 : 0;

  assign  phase_0 = (cur_count == 4'b0000 && i_clk_enable == 1'b1)? 1 : 0;
  ...
  assign output_typeconvert = ((acc_final[25] == 1'b0 & acc_final[24] != 1'b0) || (acc_final[25] == 1'b0 && acc_final[24:7] == 18'b011111111111111111) // special case0
      ...
      (acc_final[25] == 1'b1 && acc_final[24] != 1'b1) ? 18'b100000000000000000 : (acc_final[24:0] + {acc_final[7], {6{~acc_final[7]}}})>>>7;
